...
# path = "//store/group/phys_exotica/axol1tl/MC_ScoutingNano_withAXOscore/"
...
with open(out_filename, 'a') as out_file:
    ...
    for sample_name in sample_names:                
        ...
        # Test case with just one file
        out_file.write("\t\""+sample_name+"_test\" : { \n")
        ...
        for line in result.stdout.splitlines():
            ...
            if len(parts) > 4 and parts[0] != 'd' and parts[-1][-5:]==".root":  # Check if it's a file line and not a directory line
                ...
                break  # stop after the first real file
        out_file.write("\t\t} \n")
        out_file.write("\t}, \n")
